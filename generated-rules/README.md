...
| 子目录 | 内容 | 来源与验证 |
| --- | --- | --- |
| `report-release-v3-formula-20260920-fix/` | 公式树 V3 审查修复：27 事实、19 节点全 active、27 条 FBR、readiness 16/16。**未写入 MongoDB**。作废 085100 草稿。盖章建模 A；merge_group 仍是未展开黑盒 | `scripts/report_release_v3_formula_profile.py` 离线生成。规则块仍为 `e04a6861…`（42437 字符），catalogDigest `3505deed…`，ruleVersion `REPORT_RELEASE_ALL_001@20260920T092000000000Z-e04a686188f6-3505deed1600`。见 [BIZ-20260920-02](../docs/BIZ-20260920-02-report-release-formula-v3-fix.md)。 |
